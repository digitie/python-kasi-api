...
class KasiClient:
    ...
    def __init__(
        ...
        *,
        ...
        self.rate_limiter = self._http._bucket
    ...
    async def __aenter__(self) -> KasiClient:
        return self
    ...
    async def debug(self, function_name: str, /, *args: Any, **kwargs: Any) -> DebugRun:
        """public helper를 실행하고 fixture 저장용 DebugRun을 반환합니다."""

        return (await build_debug_run(self, function_name=function_name, args=args, kwargs=kwargs))


    async def debug_holidays(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("holidays", *args, **kwargs))


    async def debug_national_holidays(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("national_holidays", *args, **kwargs))


    async def debug_anniversaries(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("anniversaries", *args, **kwargs))


    async def debug_solar_terms_24(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("solar_terms_24", *args, **kwargs))


    async def debug_sundry_days(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("sundry_days", *args, **kwargs))


    async def debug_solar_to_lunar(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("solar_to_lunar", *args, **kwargs))


    async def debug_lunar_to_solar(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("lunar_to_solar", *args, **kwargs))


    async def debug_specific_lunar(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("specific_lunar", *args, **kwargs))


    async def debug_julian_day(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("julian_day", *args, **kwargs))


    async def debug_area_rise_set(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("area_rise_set", *args, **kwargs))


    async def debug_location_rise_set(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("location_rise_set", *args, **kwargs))


    async def debug_area_solar_altitude(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("area_solar_altitude", *args, **kwargs))


    async def debug_location_solar_altitude(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("location_solar_altitude", *args, **kwargs))


    async def debug_moon_phase(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("moon_phase", *args, **kwargs))


    async def debug_astro_events(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("astro_events", *args, **kwargs))


    async def debug_sundays(self, *args: Any, **kwargs: Any) -> DebugRun:
        return (await self.debug("sundays", *args, **kwargs))
